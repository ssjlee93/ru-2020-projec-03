...
import SignUpField from "../Singup";
import CategoryCard from "../CategoryCard";
import Grid from '@material-ui/core/Grid';
import Container from '@material-ui/core/Container';

// Sing in or Sign up component on Line 17 and below
// Good luck positioning it! 
function Landing() {
  return (
<Container fixed>
  ...
  Pocket Mony uses the Big Mac Index to reflect the relative value of USD (United States Dollar) you carry to another country. </p>
      </div>
      <h1 className="display-4">Sing in or Sign up component here</h1>
      <SignUpField />
